 ...
 */
final class Version20220424054105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP stripe_session');
    }
